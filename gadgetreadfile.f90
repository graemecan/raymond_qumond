...
! Data type corresponding to gadget file header
  TYPE gadgetheadertype
     CHARACTER, DIMENSION(4) :: header_title
...
! Internal variables
    ...
    READ(1)header%header_title,header%header_size
...
! ---------------------------------------------------------------------------
  ...
  SUBROUTINE gadgetreadfile(basename,ifile,header,pos,vel,id,mass,np)
!
...
! Internal variables
    ...
    CHARACTER, DIMENSION(4) :: block_title
    INTEGER :: data_size, i, file_pos, gas_skip
    ...
    READ(1)block_title,data_size
    write(*,*) "Reading Gadget2 format IC file named ",filename
    print *,"Block title: ",block_title
